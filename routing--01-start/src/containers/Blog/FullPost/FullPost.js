...
class FullPost extends Component {
    ...
    componentDidMount () {
        console.log(this.props); // here we are reaching to the web first time the componenent is loaded 
        this.loadData();
    }
    

    componentDidUpdate () {
        this.loadData(); // reaching everytime we click on different post in order to updated the dom
    }
